...
public class JWTValidatorTest {
    ...
    public static final String STRICT_CLIENT_CREDENTIAL_VALIDATION = "StrictClientCredentialValidation";
    ...
    public Object[][] createJWT() {
        ...
        properties1.setProperty(STRICT_CLIENT_CREDENTIAL_VALIDATION, "false");
        ...
        properties2.setProperty(STRICT_CLIENT_CREDENTIAL_VALIDATION, "true");
        properties2.setProperty(VALID_ISSUER, VALID_ISSUER_VAL);

        properties3.setProperty(STRICT_CLIENT_CREDENTIAL_VALIDATION, "false");
        properties4.setProperty(STRICT_CLIENT_CREDENTIAL_VALIDATION, "true");
        ...
        try {
            ...
            return new Object[][]{
                    ...
                    {jsonWebToken5, properties5, false, "JWT replay with preventTokenReuse disabled but " +
    ...
    public void testValidateToken(String jwt, Object properties, boolean expected,
        ...
        assertEquals(jwtValidator.isValidToken(signedJWT),
                expected, errorMsg);
    }
    ...
    public void testValidateNullToken() throws Exception {
        ...
        assertFalse(jwtValidator.isValidToken(null), "Validation should fail when token is null");
    }
    ...
    @Test(dependsOnMethods = "testValidateToken")
    public void testCheckJTIValidityPeriod() throws Exception {
        JWTValidator jwtValidator = getJWTValidator(new Properties());
        long currentTimeInMillis= Calendar.getInstance().getTimeInMillis();
        long expTimeInMillis = currentTimeInMillis - 10000000;
        assertTrue(jwtValidator.checkJTIValidityPeriod("1000", expTimeInMillis, currentTimeInMillis, 100));
    }

    @Test(dependsOnMethods = "testValidateToken")
    public void testValidateAgeOfTheToken() throws Exception {
        JWTValidator jwtValidator = getJWTValidator(new Properties());
        long currentTimeInMillis= Calendar.getInstance().getTimeInMillis();
    ...
    @Test(dependsOnMethods = "testValidateToken")
    public void testGenerateKSNameFromDomainName() throws Exception {
        JWTValidator jwtValidator = getJWTValidator(new Properties());
        String ksName = jwtValidator.generateKSNameFromDomainName("some.domain.com");
        assertEquals(ksName, "some-domain-com.jks", "Invalid key-store name is retrieved.");
    }
}